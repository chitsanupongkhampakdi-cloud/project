...
/* Primary Action Link (Add / เพิ่ม) */
body > a[href*="add_team"] {
...
body > a[href*="add_team"]:hover {
    background-color: #e67e22;
    transform: translateY(-2px);
    box-shadow: 0 6px 0px #873600;
}

body > a[href*="add_team"]:active {
    transform: translateY(2px);
    box-shadow: 0 1px 0px #873600;
}

/* Secondary Action Link (Home / หน้าหลัก) */
body > a[href*="index"] {
...
body > a[href*="index"]:active {
    transform: translateY(2px);
    box-shadow: 0 1px 0px #000000;
}

/* Supply Crate Management Table */
table {
    width: 100%;
...
td a[href*="edit_team"]:hover {
    background-color: #d35400;
    color: #000000;
}

/* Delete Button (Hazard Crimson) */
td a[href*="delete_team"] {
    color: #c0392b;
    border: 1px solid #922b21;
    background-color: #0e0d0c;
}

td a[href*="delete_team"]:hover {
        ...
        <?php
            foreach($result as $order){
                ...
                <tr>
                    ...
                    <td>
                        <!-- แก้ไข -->
                        <a href="edit_team.php?id=<?= $order["player_id"] ?>">แก้ไข</a>
                        <!-- ลบ -->
                        <a href="action/delete_team.php?id=<?= $order["player_id"] ?>">ลบ</a>
                    </td>
                </tr>
                <?php
            }
